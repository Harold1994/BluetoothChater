...
public class DeviceListActivity extends AppCompatActivity {
    ...
    private void updateDeviceList(){
        ...
        int hasPermission;
        hasPermission = ActivityCompat.checkSelfPermission(DeviceListActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION);
        ...
        switch (mBTSearchingState){
            ...
            case BT_SEARCH_STATE_SEARCHING: {
                if(mSearchMenuItem != null){
                    ...
                    mSearchMenuItem.setTitle(R.string.cancle);
                }
            }
            break;
        }
