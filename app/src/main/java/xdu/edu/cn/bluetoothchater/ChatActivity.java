...
public class ChatActivity extends AppCompatActivity {
    ...
    private ListView mMessagerListView;
    private EditText mMessageEditor;
    private MenuItem mConnectionMenuItem;

    private final static int MSG_SEND_DATA = 0;
            ...
            switch (msg.what){
                case MSG_SEND_DATA: {
                    ...
                    if(data != null && suc){
                        ...
                        MessagerAdapter adapter = (MessagerAdapter) mMessagerListView.getAdapter();
                        adapter.add(chatMsg);
                ...
                case MSG_RECEIVE_DATA: {
                    ...
                    if(data != null) {
                        ...
                        ChatMessage chatMsg = new ChatMessage();
                        chatMsg.messageSender = ChatMessage.MSG_SENDER_OTHER;
                        chatMsg.messageContent = new String(data);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMessagerListView = (ListView) findViewById(R.id.msg_list);
        MessagerAdapter adapter = new MessagerAdapter(this, R.layout.me_list_item, R.layout.others_list_item);
        mMessagerListView.setAdapter(adapter);
    ...
    private  ConnectionManager.ConnectionListener mConnectionListener = new ConnectionManager.ConnectionListener(){
        ...
        public void onSendData(boolean suc, byte[] data) {
            mHandler.obtainMessage(MSG_SEND_DATA, suc?1:0, 0, data).sendToTarget();
        }
    ...
    private void sendMessage() {
        ...
        if(content != null){
            ...
            if(content.length() > 0){
                ...
                if(!ret){
                    Toast.makeText(ChatActivity.this, R.string.send_fail, Toast.LENGTH_LONG).show();
    ...
    private void updateUI() {
        ...
        if(mConnectionManager.getCurrentConnectState() == ConnectionManager.LISTEN_STATE_IDLE){
        ...
        else if(mConnectionManager.getCurrentConnectState() == ConnectionManager.CONNECT_STATE_CONNECTED){
            ...
            mConnectionMenuItem.setTitle(R.string.cancle);
